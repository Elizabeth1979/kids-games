...
export default function QuestionDisplay({
  ...
  return (
    <div className="bg-card rounded-3xl p-8 md:p-12 shadow-xl border-4 border-border mb-6">
      <div className="text-center">
        <div className="text-6xl md:text-8xl font-bold text-foreground mb-4 font-mono">
